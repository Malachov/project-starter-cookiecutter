...
import pyvueeel
from pyvueeel import run_gui, expose, eel, to_vue_plotly  # json_to_py
...
def test_function(params, arg1="default", arg2="default"):  # **DELETELINE
    ...
    #                                                                                                                               # **DELETELINE
    return to_vue_plotly(store.data)  # **DELETELINE
...
if __name__ == "__main__":
    ...
    run_gui(build_gui_path=Path(__file__).parent / "gui" / "web_builded")
